...
<br />
<br />
	<table width="800" align="center" cellspacing="0" cellpadding="0" class="openTable">
		<tr>
	...
	<table width="800" align="center" class="midTable">
	<tr>
	<td>
	</cfif>
	...
	<table width="800" align="center" class="midTable">
		<tr>
			<td class="notify" align="center"><cfoutput>#session.message#</cfoutput></td>
		</tr>
	</table>
...
<cfset session.newJobs=#newJobs.recordcount#>
    ...
    <table width="800" align="center" class="midTable" cellspacing="0">
      <tr> <cfoutput>
